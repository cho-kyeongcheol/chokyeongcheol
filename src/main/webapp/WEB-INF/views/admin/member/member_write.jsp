			...
			<form role="form" action="/admin/member/write" method="POST">
				...
				<div class="row">
					<div class="col-sm-4">
						<!-- textarea -->
						<div class="form-group">
							<label>enabled</label> <input type="text" name="enabled" class="form-control"
								placeholder="Enter point">
						</div>
					</div>
				</div>
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							<label><font style="vertical-align: inherit"><font
									style="vertical-align: inherit">Writer</font></font></label>
				...
				<div class="form-group">
					<label>아래 영역에 파일을 드래그 해서 업로드</label>
				</div>
				<br>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="form-group">
							<label>enabled</label> <select name="enabeld" class="form-control">

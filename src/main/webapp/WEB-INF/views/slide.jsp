  ...
  <section class="banner_slider">
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix">
				   <img class="col-4" src="/resources/images/kakao.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix">
				   <img class="col-8 fr last" src="/resources/images/kakao.jpg" alt="" width="620" height="416" />
				   <div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3">
					<img src="/resources/images/kakao.jpg" alt="" width="218" height="325" />
					<h5>글로벌윙사이트 리뉴얼 완료</h5>
					<p>사이트URL: www.globalwing.co.kr ( 제로보드xe기반 ) -> 워드프레스 기반으로 리뉴얼완료
					글로벌윙 사이트 메인시안</p>
				</li>
				<li class="col-3">
					<img src="/resources/images/kakao.jpg" alt="" width="218" height="326" />
					<h5>크리웰터 사이트 오픈완료.</h5>
					<p>크리웰터 사이트 작업중 입니다. 워드프레스 기반의 영문홈페이지 입니다.
					오픈되었습니다.</p>
				</li>
				<li class="col-6 last">
					<img src="/resources/images/kakao.jpg" alt="" width="459" height="324" />
					<h5>에코바스 사이트 작업완료.</h5>

				...
				<fieldset>
					...
					<ul class="app_list">						
						<li class="clear">
							...
							<div class="app_content"><input type="text" class="w100p" id="title_lbl" placeholder="제목을 입력하세요."/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="password" class="w100p" id="pwd2_lbl" placeholder="이름을 입력해주세요."/></div>
						</li>
											
					</ul>
					<p class="btn_line"><a href="notice_list.html" class="btn_baseColor">등록</a>
					<a href="/resources/home/notice_list.html" class="btn_baseColor">목록</a></p>	

...
public class PageVO {
	...
	private void calcPage() {
		...
		this.prev = this.startPage !=1;//시작페이지 1보다 크면 무조건 이전 페이지가 있따. true
	...
	public int getStartBno() {
		//DB쿼리에서 사용.. 시작데이터번호 = (jsp클릭한 페이지번호-1)*페이지당 보여주는 개수
	...
	public void setTotalCount(int totalCount) {
		...
		calcPage(); //totalCount 전체 게시물개수가 있어야지 페이지계산을 할수 있기 때문에
	}
